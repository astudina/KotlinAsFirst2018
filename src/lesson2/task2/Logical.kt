...
fun isNumberHappy(number: Int): Boolean {
    val x = number / 1000
    val y = (number - x * 1000) / 100
    val z = (number - x * 1000 - y * 100) / 10
    val w = number - x * 1000 - y * 100 - z * 10
    return when {
        x + y == z + w -> true
        else -> false
    }
...
fun leapyear(leapornot: Int): Boolean {
    return when {
        ((leapornot % 400 == 0) || ((leapornot % 4 == 0) && (leapornot % 100 != 0))) -> true
        else -> false
    }
}
...
fun circleInside(x1: Double, y1: Double, r1: Double,
    ...
    val z = sqrt(pow(x2 - x1, 2.0 ) + pow(y2 - y1, 2.0 ))
    return when {
        r2 >= z + r1 -> true
        else -> false
    }
